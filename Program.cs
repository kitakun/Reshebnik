...
builder.Services.AddScoped<EmployeeArchiveHandler>();
builder.Services.AddScoped<ArchivedUserGetHandler>();
builder.Services.AddScoped<ArchivedUserTypeaheadHandler>();
builder.Services.AddScoped<EmployeeUnarchiveHandler>();
