...
namespace Reshebnik.EntityFramework.Migrations
{
    ...
    [Migration("20250903170801_ArchiveUserEntities")]
    partial class ArchiveUserEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Reshebnik.Domain.Entities.ArchivedUserEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Reshebnik.Domain.Entities.CategoryRecordEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Reshebnik.Domain.Entities.ArchivedMetricEntity", b =>
                {
                    b.HasOne("Reshebnik.Domain.Entities.EmployeeEntity", "ArchivedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Reshebnik.Domain.Entities.ArchivedUserEntity", b =>
                {
                    ...
                    b.HasOne("Reshebnik.Domain.Entities.EmployeeEntity", "Employee")
                        ...
                        .HasForeignKey("Reshebnik.Domain.Entities.ArchivedUserEntity", "EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Reshebnik.Domain.Entities.IndicatorEntity", b =>
                {
                    b.HasOne("Reshebnik.Domain.Entities.ArchivedMetricEntity", "ArchivedMetric")
                        .WithOne("Indicator")
                        .HasForeignKey("Reshebnik.Domain.Entities.IndicatorEntity", "ArchiveMetricId")
