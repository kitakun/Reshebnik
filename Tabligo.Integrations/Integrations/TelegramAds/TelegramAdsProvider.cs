...
namespace Tabligo.Integrations.Integrations.TelegramAds;

public class TelegramAdsProvider : IIntegrationProvider
{
    public IntegrationTypeEnum Type => IntegrationTypeEnum.TelegramAds;
    ...
    {
        // TODO: Implement TelegramAds API connection test
        await Task.Delay(100, ct); // Placeholder
        return new IntegrationTestConnectionResult
        {
            IsSuccess = false,
            Reason = "Интеграция с Telegram Ads еще не реализована",
            Endpoint = "TelegramAds API",
            IntegrationType = IntegrationTypeEnum.TelegramAds
        };
    }
