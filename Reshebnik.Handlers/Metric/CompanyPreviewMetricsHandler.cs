        ...
        CancellationToken ct = default)
{
    ...
    var last12Range = periodType switch
    {
        ...
        PeriodTypeEnum.Month => new DateRange(new DateTime(range.To.AddMonths(-11).Year, range.To.AddMonths(-11).Month, 1),
    ...
    if (metricPeriod == PeriodTypeEnum.Week && (periodType == PeriodTypeEnum.Day || periodType == PeriodTypeEnum.Custom))
